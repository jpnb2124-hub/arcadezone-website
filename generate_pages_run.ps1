# Generator with safe SVG placeholder handling
...
<svg xmlns="http://www.w3.org/2000/svg" width="640" height="360">
  ...
  <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Arial,Helvetica,sans-serif" font-size="28" fill="#111">__TITLE__</text>
</svg>
'@
...
foreach ($row in $csv) {
  ...
  $svgContent = $svgTemplate -replace '__TITLE__', $escapedTitle
